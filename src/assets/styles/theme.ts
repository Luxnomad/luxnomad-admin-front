...
export const theme: DefaultTheme = {
  ...
  typography: {
    ...
    [TYPOGRAPHY_THEME.SUBTITLE_2]: 'font-size: 16px; font-weight: 600; line-height: 1.4;',
    [TYPOGRAPHY_THEME.BODY_1]: 'font-size: 20px; font-weight: 400; line-height: 1.4;',
    [TYPOGRAPHY_THEME.BODY_2]: 'font-size: 16px; font-weight: 400; line-height: 1.4;',
    [TYPOGRAPHY_THEME.BODY_3]: 'font-size: 14px; font-weight: 400; line-height: 1.4;',
    [TYPOGRAPHY_THEME.CAPTION_1]: 'font-size: 12px; font-weight: 400; line-height: 1.4;',
  },
  color: {
